    ...
    return (
      <View style={styles.container} >
        ...
        <View style={styles.containerButton} >
          ...
          <ScrollView style={{height:50, width:100, paddingLeft:15}}>
        ...
        <View style={{ flexDirection: 'row', paddingTop: 50 , flex:1 }}>

          {
            this.state.operator != '' && (
              <Text style={{ fontSize: 20 }}>RESULT: {this.state.a}  {this.state.operator}  {this.state.b}  = {this.state.result}</Text>
            )
          }
        </View>
      </View>
